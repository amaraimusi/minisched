...
<div style="max-width:840px;margin: auto;">
	...
	<!-- CBBXS-6007 -->
	<div class="row mt-2">
		<div class='col-md-2' >週始め日（月曜日の日付）</div>
		<div class='col-md-10'>
			<!-- datetime-local要素はpattern属性を指定できないので注意。強制的にバリデーションが発動してまう。秒単位の入力にするにはstep="1"を追記 -->
			<input type="date" name="week_start_date" class="form-control form-control-lg " value="" step="1" title="日時形式（Y-m-d H:i:s）で入力してください(例：2012-12-12 01:02:03)" />
			<span class="text-danger" data-valid-err="week_start_date" ></span>
		</div>
	</div>
	
	<div class="row mt-2">
		<div class='col-md-2 ' >奉仕場所</div>
		<div class='col-md-10'>
			<input type="text" name="location" class="form-control form-control-lg " value=""  maxlength="255"  required title="奉仕場所は255文字以内で入力してください" />
			<span class="text-danger" data-valid-err='location'></span>
		</div>
	</div>
	...
	<div class="row mt-2">
		...
		<div class='col-md-10'>
			<textarea name="notes" class="form-control form-control-lg " maxlength="2000" title="2000文字以内で入力してください" ></textarea>
			<div class="text-danger" data-valid-err="notes"></div>
		</div>
	</div>
