...
<head>
	...
	<script src="{{ asset('/js/ServiceTemplate/edit.js')  . $ver_str}} }}" defer></script>
	...
	<link href="{{ asset('/css/ServiceTemplate/edit.css')  . $ver_str}}" rel="stylesheet">
	
	<title>奉仕テンプレ管理・編集フォーム</title>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page">奉仕テンプレ管理・編集フォーム</li>
  </ol>
</nav>
...
<div>
	<div class="form_w" >
		<form id="form1" method="POST" action="{{ url('service_template/update') }}" enctype="multipart/form-data">
			@csrf
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="service_name" type="text"  class="form-control form-control-lg" placeholder="service_name" value="{{old('service_name', $ent->service_name)}}" required  title="奉仕名（例：火曜日の5時からの奉仕）を入力してください。">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="conductor_name" type="text"  class="form-control form-control-lg" placeholder="conductor_name" value="{{old('conductor_name', $ent->conductor_name)}}" required  title="担当司会者を入力してください。">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="sub_conductor_name" type="text"  class="form-control form-control-lg" placeholder="sub_conductor_name" value="{{old('sub_conductor_name', $ent->sub_conductor_name)}}" required  title="補助担当（いない場合もあり）を入力してください。">
				</div>
			</div>
